package com.tang.understander.view;
...
public class DropDownListView extends ListView implements OnScrollListener {
    ...
    private void initDropDownStyle() {
        ...
        headerLayout = (RelativeLayout)inflater.inflate(R.layout.dropdownlist_header, this, false);
    ...
    private void initOnBottomStyle() {
        ...
        LayoutInflater inflater = (LayoutInflater)context.getSystemService(Context.LAYOUT_INFLATER_SERVICE);
        footerLayout = (RelativeLayout)inflater.inflate(R.layout.dropdownlist_footer, this, false);
