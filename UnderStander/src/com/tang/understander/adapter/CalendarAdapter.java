...
import com.tang.understander.db.TaskCurrentDayDBAdapter;
import com.tang.understander.utils.LunarCalendar;
import com.tang.understander.utils.SpecialCalendar;
...
//	private static String week[] = {"周日","周一","周二","周三","周四","周五","周六"};
	...
	public CalendarAdapter(Context context,Resources rs,int jumpMonth,int jumpYear,int year_c,int month_c,int day_c){
		...
		Object[] monthtasks  =getCurrentMonthTask(startdate,enddate);
...
//        Log.d("DAYNUMBER",abc);
	 ...
	 * @return
	 */
	private Object [] getCurrentMonthTask(String startdate ,String enddate){
		Object [] tasks = null;
		
		TaskCurrentDayDBAdapter dbAdapter = new TaskCurrentDayDBAdapter();
		try {
			dbAdapter.open();
			tasks = dbAdapter.getTaskCurrentMonth(startdate, enddate);
